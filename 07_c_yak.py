# YAK Authenticated Key Exchange Protocol (Simplified)
...
# Alice computes K = (Y * B_pub^y)^x mod p
# Bob computes K = (X * A_pub^x)^y mod p
# (Simplified version for demo)
alice_key = power_mod(Y, a_priv + x, p)
bob_key = power_mod(X, b_priv + y, p)
